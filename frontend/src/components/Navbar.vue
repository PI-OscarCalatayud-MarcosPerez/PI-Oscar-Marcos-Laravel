    ...
    <div class="nav-container">
      ...
      <nav id="navLinks" aria-label="Menú principal">
        <ul class="enlaces_navegacion" :class="{ active: isMenuOpen }">
          ...
          <li><RouterLink to="/products">Comprar</RouterLink></li>
          <li><a href="#">Vender</a></li>
          <li><RouterLink to="/contacto">Contacto</RouterLink></li>
          <li><RouterLink to="/import">Subir</RouterLink></li>
        </ul>
      </nav>
      ...
      <div class="d-flex align-items-center gap-3">
        ...
        <RouterLink v-if="authStore.isAuthenticated" to="/dashboard" class="users" aria-label="Perfil"></RouterLink>
