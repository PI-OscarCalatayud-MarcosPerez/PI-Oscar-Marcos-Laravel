...
@section('content')
    <div class="inicio-container">
      <div class="video-background">
        <video
          ...
          loop
          playsinline
          aria-label="Video ambiental de introducción a videojuegos"
        >
    ...
    <main class="container-fluid px-0" id="main-content" role="main">
      ...
      <div
        ...
        role="region"
        aria-label="Juegos más comprados"
      >
        <button
          class="nav-btn prev-btn"
          onclick="scrollCarousel('lista-comprados', -1)"
      ...
      <div
        class="custom-carousel-container"
        role="region"
        aria-label="Mejores ofertas"
      >
        <button
          class="nav-btn prev-btn"
          onclick="scrollCarousel('lista-ofertas', -1)"
          aria-label="Ver anteriores"
        >
          <img src="{{ asset('img/izquierda.png') }}" alt="" />
        </button>
      ...
      <div
        class="custom-carousel-container"
        role="region"
        aria-label="Software e IA"
      >
        <button
          class="nav-btn prev-btn"
          onclick="scrollCarousel('lista-nuevos', -1)"
          aria-label="Ver anteriores"
        >
          <img src="{{ asset('img/izquierda.png') }}" alt="" />
        </button>
